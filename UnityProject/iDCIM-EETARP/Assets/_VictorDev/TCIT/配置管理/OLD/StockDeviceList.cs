...
public class StockDeviceList : MonoBehaviour, StockDeviceDataManager.IReceiverStockDeviceModelDataExtended
{
    ...
    private List<DeviceModelDataExtended> ServerDeviceDataList => GetDeviceDataByDeviceKind(EnumRevitModelKind.Server);
    private List<DeviceModelDataExtended> RouterDeviceDataList => GetDeviceDataByDeviceKind(EnumRevitModelKind.Router);
    private List<DeviceModelDataExtended> SwitchDeviceDataList => GetDeviceDataByDeviceKind(EnumRevitModelKind.Switch);

    private List<DeviceModelDataExtended> GetDeviceDataByDeviceKind(EnumRevitModelKind deviceKind) =>
