...
namespace VictorDev.Common
{
    ...
    public static class Debug
    {
        ...
        public static void DrawRay(Ray ray, float distance, Color? rayColor=null, float duration = 0.01f) => UnityEngine.Debug.DrawRay(ray.origin, ray.direction * distance, rayColor ?? Color.green, duration);
    } 
} 